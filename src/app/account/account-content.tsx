  ...
  if (!user) {
    ...
    return (
      <div className="admin-layout">
        ...
        <main className="admin-main" style={{ background: 'radial-gradient(circle at 50% 50%, rgba(4, 187, 255, 0.03) 0%, transparent 100%)' }}>
          ...
          <div className="admin-content" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <div className="card" style={{ width: '100%', maxWidth: 850, padding: '2.5rem' }}>
                ...
                <form onSubmit={handleProfileSave} className="account-form">
                  ...
                  <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                    ...
                    <input type="tel" value={profilePhone} onChange={e => setProfilePhone(e.target.value)} placeholder="+228 XX XX XX XX" style={{ width: '100%' }} />
                  </div>
            ...
            {tab === 'assistant' && (
              <div style={{ width: '100%', maxWidth: 1000 }}>
                <div style={{ marginBottom: '1.5rem' }}>
                  <h2 style={{ fontSize: '1.8rem', color: 'var(--clr-accent)', marginBottom: '0.5rem' }}>Assistant IA</h2>
                  <p style={{ color: 'var(--clr-muted)' }}>Posez vos questions sur l&apos;électronique, le code ou vos commandes.</p>
                </div>
