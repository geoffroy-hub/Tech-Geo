...
export default function BusinessPage() {
  ...
  return (
    <div className="business-page">
      <section className="hero-sm" style={{ backgroundImage: 'url(/images/business-bg.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 400px))', justifyContent: 'center', gap: '2rem' }}>
            ...
            <div className="card hover-lift" style={{ overflow: 'hidden', padding: 0, border: '1px solid rgba(4, 187, 255, 0.2)', maxWidth: '350px', margin: '0 auto' }}>
              <div style={{ height: '500px', background: 'rgba(0,0,0,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <img 
                  src="/images/Business/images.jpg" 
