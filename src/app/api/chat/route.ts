...
export async function POST(req: Request) {
  try {
    ...
    // Initialiser Supabase (côté serveur pour ignorer RLS si nécessaire, mais ici on lit juste une clé publique ou config)
    // On utilise les variables d'environnement pour Supabase
