        ...
        <div className="container">
          <div className="newsletter-section animate-on-scroll">
            ...
            <form className="newsletter-form" id="newsletter-form">
              ...
              <button type="submit" className="btn btn-primary ripple">S&apos;inscrire</button>
            </form>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="grid-4">
            {[
              ...
              { src: '/images/tutorial-photos/LED DISTANCE INDICATOR.jpg', label: 'Indicateur LED' },
              { src: '/images/tutorial-photos/top-view-wires-tech-background.jpg', label: 'Câblage Précis' },
              { src: '/images/tutorial-photos/Arduino vs ESP8266 vs ESP32 Microcontroller Comparison - DIYI0T.jpg', label: 'Comparaison MCU' },
              { src: '/images/tutorial-photos/Régulateur de tension LM317 _ montages - Astuces Pratiques.jpg', label: 'Montage LM317' },
              { src: '/images/tutorial-photos/top-view-diverse-group-people-600nw-2757624093.jpg', label: 'Notre Communauté' },
            ].map((img, i) => (
              <div key={i} className="card" style={{ padding: 0, overflow: 'hidden' }}>
                <img src={img.src} alt={img.label} loading="lazy" style={{ width: '100%', height: 220, objectFit: 'cover' }} />
