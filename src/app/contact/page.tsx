...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    { title: 'Email', value: 'contact@tech-geo.com', icon: '✉️' },
  ...
  return (
    <>
      <section className="hero-sm" style={{ backgroundImage: 'url(/images/tutorial-photos/various-radio-components-soldering-iron-600nw-2695650513.jpg)' }}>
      ...
      <section className="section" style={{ borderTop: '1px solid var(--clr-teal)' }}>
        <div className="container text-center">
          ...
          <form style={{ maxWidth: 500, margin: '0 auto', display: 'flex', gap: '0.5rem' }}>
            <input type="email" placeholder="votre@email.com" style={{ flex: 1 }} />
